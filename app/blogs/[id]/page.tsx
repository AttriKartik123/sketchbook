...
//       content: `<p>Portrait sketching is one of the most rewarding...</p>`,
//       image: "/art1.jpg",
...
// // ✅ PAGE MUST BE AN ASYNC FUNCTION AND EXPORT DEFAULT
// export default function Page({ params }: { params: { id: string } }) {
//   const post = getBlogPost(params.id)

//   if (!post) {
//     return <div className="text-center p-20 text-xl">Post not found</div>
//   }
